---
id: "/activer-le-http-2-push-sur-wordpress"
path: "/activer-le-http-2-push-sur-wordpress"
date: "2019-04-03"
title: "Activer le HTTP/2 push sur Wordpress"
category: "Webperf"
tags:
  - "Français"
cover: "./http2-push-verification-dans-chrome-outils-developeur-onglet-reseau-colonne-initiator.jpg"
tldr: "En plus du gain déjà apporté par le multiplexage avec http/2 on va pouvoir accélérer encore en envoyant des données au client avant même qu'il ne les ait demandé ! "
draft: false
---
...
[![http2 server push plugin wordpress](./http2-server-push-plugin-wordpress.jpg)](https://fr.wordpress.org/plugins/http2-server-push/)
...
![http2 push vérification dans chrome outils dévelopeur onglet réseau colonne initiator](./http2-push-vérification-dans-chrome-outils-dévelopeur-onglet-réseau-colonne-initiator.jpg)
