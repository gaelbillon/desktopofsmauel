...
![http2 push vérification dans chrome outils dévelopeur onglet réseau colonne initiator](./http2-push-verification-dans-chrome-outils-developeur-onglet-reseau-colonne-initiator.jpg)
