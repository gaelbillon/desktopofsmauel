...
- NextJS
- Français
tldr: Pages générées quand au build avec Gatsby. NextJS génère une nouvelle page à
  chaque requête. Gestion des données strict avec Gatsby. Plus libre mais demande
  plus de travail avec NextJS.
