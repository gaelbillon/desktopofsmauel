---
id: "/acceder-localhost-avec-lemulateur-genymotion"
path: "/acceder-localhost-avec-lemulateur-genymotion"
...
Ca peut servir par exemple pour [débugger une web app avec Weinre](/debugger-facilement-des-applications-sites-mobiles/ "Debugger facilement des applications & sites mobiles").
