---
id: "/a-node-js-module-to-read-serial-port-data"
path: "/a-node-js-module-to-read-serial-port-data"
...
tags: 
  ...
  - "pll_5bf81c186da63"
  - "Uncategorized"
tldr: "Serialport is a Node.js module to read and write data on a serial port, here's a quick overview of its usage with a an APM board with Ardupilot software."
cover: "./node.js-serialport-sublime-text-screenshot-1.png"
draft: false
---

[Serialport](https://npmjs.org/package/serialport) is a node.js module that reads the serial port data. It opens up a lot of doors for javascript such as... switching on the living room light or... [communicate with a drone](/work/uav-ground-control-station-web-app-with-node-serialport/) !
