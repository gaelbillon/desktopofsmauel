---
id: "/creer-un-virtual-host-une-elastic-ip-et-rediriger-son-domaine-vers-ec2"
path: "/creer-un-virtual-host-une-elastic-ip-et-rediriger-son-domaine-vers-ec2"
...
[![aws ec2 allocate new elastic IP](./Screen-shot-2013-05-10-at-4.42.48-PM-624x390.png)](/posts/wp-content/uploads/2013/05/Screen-shot-2013-05-10-at-4.42.48-PM.png) et dans elastic ip, “allocate new adress”

[![allocate new elastic IP on amazon aws ec2](./Screen-shot-2013-05-10-at-4.42.55-PM-624x390.png)](/posts/wp-content/uploads/2013/05/Screen-shot-2013-05-10-at-4.42.55-PM.png)

On choisi ec2 et on associe ensuite l’ip avec l’instance crée dans ce post

[![allocate new elastic IP on amazon aws ec2 associate with instance](./Screen-shot-2013-05-10-at-4.43.18-PM-624x390.png)](/posts/wp-content/uploads/2013/05/Screen-shot-2013-05-10-at-4.43.18-PM.png)

 

[![aws ec2 new elastic ip created](./Screen-shot-2013-05-10-at-4.43.24-PM-624x390.png)](/posts/wp-content/uploads/2013/05/Screen-shot-2013-05-10-at-4.43.24-PM.png)
