...
Commento should now display the imported comments. Go to a post where you know there are comments and check if they are correctly displayed. in my case : [/prendre-des-photos-en-dng-raw-avec-le-parrot-anafi-et-pix4d-capture](/prendre-des-photos-en-dng-raw-avec-le-parrot-anafi-et-pix-four-d-capture)
