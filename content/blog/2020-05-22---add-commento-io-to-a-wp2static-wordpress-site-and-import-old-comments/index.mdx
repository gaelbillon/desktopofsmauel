---
id: "/add-commento-io-to-a-static-wordpress-website-and-import-old-comments"
path: "/add-commento-io-to-a-static-wordpress-website-and-import-old-comments"
date: "2020-05-22"
...
tags: 
  ...
  - "JAMstack"
  - "Static"
tldr: "How to setup commento.io to get comments on a WP2static Wordpress website"
cover: "./2020-05-21-at-11.57.57.png"
draft: false
---
...
![Wordpress WP2Static Commento.io and dev domain](./2020-05-21-at-11.55.10.png)
...
![Wordpress WP2Static Commento.io enfold theme textarea too small](./2020-05-21-at-11.57.57.png)
...
![Wordpress WP2Static Commento.io export Wordpress comments XML](./2020-05-21-at-12.50.59.png)
...
![Wordpress WP2Static Commento.io import Wordpress xml comments to Disqus](./2020-05-21-at-12.54.19-1030x671.png)
...
Commento should now display the imported comments. Go to a post where you know there are comments and check if they are correctly displayed. in my case : [https://gaelbillon.com/posts/prendre-des-photos-en-dng-raw-avec-le-parrot-anafi-et-pix4d-capture/](/prendre-des-photos-en-dng-raw-avec-le-parrot-anafi-et-pix-four-d-capture)

It works !

![Wordpress WP2Static Commento.io comments username fixed](./2020-05-21-at-14.45.01.png)
...
![Wordpress WP2Static Commento.io import xml disqus search replace](./2020-05-21-at-14.44.37-1030x666.png)