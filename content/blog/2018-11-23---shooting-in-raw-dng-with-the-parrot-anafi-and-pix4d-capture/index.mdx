---
id: "/shooting-in-raw-dng-with-the-parrot-anafi-and-pix-four-d-capture"
path: "/shooting-in-raw-dng-with-the-parrot-anafi-and-pix-four-d-capture"
date: "2018-11-23"
...
tags:
  - "English"
  - "uav"
cover: "./Pix4D-Parrot-Anafi-record-RAW-DNG-FreeFlight-reconnected.jpg"
tldr: "The Pix4D Capture application only records JPGs. Fortunately it is possible to bypass this limitation and record the pictures in DNG (RAW). "
draft: false
---
...
![Pix4D Parrot Anafi record RAW DNG FreeFlight reconnected](./Pix4D-Parrot-Anafi-record-RAW-DNG-FreeFlight-reconnected-300x169.jpg)

The Pix4D Capture application is very well designed to prepare flight plans, whether grid, double grid, polygon or circular. Preparing a flight plan is very simple, even on a small smartphone and all the important settings such as camera coverage or tilt are present. The only downside when doing [photogrammetry with Parrot Anafi and Pix4D Capture](/photogrammetry-with-parrot-anafi-and-pix-four-d-capture/), the app only records JPGs and this is also the case with other drones such as DJI's.
...
2. Open Pix4D Capture and create a flight plan ![Pix4D Parrot Anafi record RAW DNG photos with Pix4D Capture](./Pix4D-Parrot-Anafi-record-RAW-DNG-photos-with-Pix4D-Capture-1030x580.jpg)
...
![Pix4D Parrot Anafi record RAW DNG photos drone takeoff checklist](./Pix4D-Parrot-Anafi-record-RAW-DNG-photos-drone-takeoff-checklist-1030x580.png)
<figcaption>Once "Mission uploaded to drone" is in green, press "Cancel</figcaption>

4. Launch the FreeFlight application and go to the "Fly" screen. ![Pix4D Parrot Anafi record RAW DNG FreeFlight Pix4D switch](./Pix4D-Parrot-Anafi-record-RAW-DNG-FreeFlight-Pix4D-switch-e1542816095332-1030x580.jpg)
  

![Pix4D Parrot Anafi record RAW DNG FreeFlight not connected](./Pix4D-Parrot-Anafi-record-RAW-DNG-FreeFlight-not-connected-1030x580.jpg)
...
6. Modify the photo settings: DNG/JPG, Style, iso, shutter speed. You can choose all the parameters at your convenience, they will then be used during the automatic flight. ![Pix4D Parrot Anafi record RAW DNG choose photo settings](./Pix4D-Parrot-Anafi-record-RAW-DNG-choose-photo-settings-1030x580.jpg)
...
![Pix4D Parrot Anafi record RAW DNG exif ISO 3200 shutter speed 1-4000](./Pix4D-Parrot-Anafi-record-RAW-DNG-exif-ISO-3200-shutter-speed-1-4000.jpg)
<figcaption>We do have an exposure time of 1/400 and ISO at 3200 as previously defined in FreeFlight</figcaption>

![Pix4D Parrot Anafi record RAW DNG gallery](./Pix4D-Parrot-Anafi-record-RAW-DNG-gallery-1030x580.jpg)
...
![Pix4D Parrot Anafi record RAW DNG photos arror when uploading images](./Pix4D-Parrot-Anafi-record-RAW-DNG-photos-arror-when-uploading-images-1030x580.png)
...
![Pix4D Parrot Anafi record RAW DNG HoudaGeo Pix4D Capture](./Pix4D-Parrot-Anafi-record-RAW-DNG-HoudaGeo-Pix4D-Capture.jpg)
...
![Pix4D Parrot Anafi record RAW DNG HoudaGeo Exif timestamp](./Pix4D-Parrot-Anafi-record-RAW-DNG-HoudaGeo-Exif-timestamp-1030x680.jpg)
