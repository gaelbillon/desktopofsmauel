---
id: "/photogrammetry-with-parrot-anafi-and-pix-four-d-capture"
path: "/photogrammetry-with-parrot-anafi-and-pix-four-d-capture"
date: "2018-11-21"
...
tags:
  ...
  - "English"
  - "Pix4D"
cover: "./Photogrammetry-with-Parrot-Anafi-and-Pix4D-Capture-flight-plan-on-iPhone-5S-1030x580.jpg"
tldr: "One of the simplest, most intuitive and compact solution for photogrammetry at the moment. A very good volume/weight/price/image quality ratio. "
draft: false
---
...
![Photogrammetry with Parrot Anafi and Pix4D Capture flight plan on iPhone 5S](./Photogrammetry-with-Parrot-Anafi-and-Pix4D-Capture-flight-plan-on-iPhone-5S-1030x580.jpg)
...
\[caption id="attachment\_1043" align="aligncenter" width="750"\]![Photogrammetry with Parrot Anafi and Pix4D Capture upload images Pix4D cloud](./Photogrammetry-with-Parrot-Anafi-and-Pix4D-Capture-upload-images-Pix4D-cloud-1030x580.jpg) With the default settings, downloading photos from the Anafi starts immediately after landing\[/caption\]
...
Update: there is actually a way (not official) to [record DNGs with Pix4D Capture](/shooting-in-raw-dng-with-the-parrot-anafi-and-pix-four-d-capture).
...
![Photogrammetry with Parrot Anafi and Pix4D Capture photos EXIF geotagged](./Photogrammetry-with-Parrot-Anafi-and-Pix4D-Capture-photos-EXIF-geotagged-1030x604.png)

\[caption id="attachment\_1045" align="aligncenter" width="750"\]![Pix4D Parrot Anafi photogrammetry photo JPG](./P0770078-1030x774.jpg) Open the [full resolution image](./P0770078.jpg) (5344 × 4016 | 5.6 MB) in a new tab\[/caption\]
