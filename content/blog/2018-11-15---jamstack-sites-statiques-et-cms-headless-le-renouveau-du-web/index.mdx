---
id: "/jamstack-sites-statiques-et-cms-headless-le-renouveau-du-web"
path: "/jamstack-sites-statiques-et-cms-headless-le-renouveau-du-web"
...
tags: 
  ...
  - "Sites statiques"
  - "statique"
tldr: "Générateur de sites statiques, APIs, Functions as a Service et CMS sans tête, voici les acteurs d'un mouvement qui révolutionne le développement web"
cover: "./gatsby-contentful-visual-studio-code.png"
draft: false
---
...
Un article plus approfondi sur les CMS headless : [CMS headless: avantages, inconvénients & comparatif des 5 leaders](/cms-headless-avantages-inconvenients-comparatif-des-5-leaders)
...
![Exemple de workflow de l'agence web New Yorkaise Carrot Creative](./workflow-contentful-static.png) 
