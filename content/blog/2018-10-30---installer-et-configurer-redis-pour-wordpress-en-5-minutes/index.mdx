---
id: "/installer-et-configurer-redis-pour-wordpress-en-5-minutes"
path: "/installer-et-configurer-redis-pour-wordpress-en-5-minutes"
...
tags: 
  ...
  - "temps de chargement"
  - "vitesse"
tldr: "Redis est une store clé-valeur qui permet de garder en mémoire les requêtes MySQL. C'est un système de mise en cache très simple à mettre en oeuvre."
cover: "./wordpress-redis.png"
draft: false
---

![Configuration Redis et Wordpress avec le plugin Redis Object Cache](./wordpress-redis-medium.png)
...
![Configuration Redis et Wordpress avec le plugin Redis Object Cache](./Configuration-Redis-et-WordPress-avec-le-plugin-Redis-Object-Cache.png)
