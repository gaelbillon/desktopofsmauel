---
id: "/cms-headless-avantages-inconvenients-comparatif-des-5-leaders"
path: "/cms-headless-avantages-inconvenients-comparatif-des-5-leaders"
...
tags: 
  ...
  - "Français"
  - "Sites statiques"
tldr: "Les CMS headless reposent sur un découplage fort ente le contenu et sa présentation. A l'heure de la multiplication des interfaces. Le contenu n'est plus toujours solidaire du front end."
cover: "./Headed-and-Headless-CMS-comparison-Drupal-Wordpress-Prestashop-Cockpit-Prismic-Contentful-Directus-Dato.png"
draft: false
---

![Headless CMS comparison](./Headed-and-Headless-CMS-comparison-Drupal-Wordpress-Prestashop-Cockpit-Prismic-Contentful-Directus-Dato-featurred.png)
...
Le CMS headless est un excellent compagnon aux [sites statiques](/jamstack-sites-statiques-et-cms-headless-le-renouveau-du-web) tels que ceux que l'on peut developper avec [Gatsby](/gatsby-le-generateur-de-site-statique-base-sur-react-et-graphql) par exemple
...
![Interface utilisateur du CMS headless Contentful](./contentful-headless-CMS-interface-utilisateur.jpg)
...
![Interface utilisateur du CMS headless DatoCMS](./DatoCMS-headless-CMS-interface-utilisateur.jpg)
...
![Interface utilisateur du CMS headless Prismic](./Interface-du-CMS-headless-Prismic.png)
...
![Interface utilisateur du CMS headless Directus](./Interface-du-CMS-headless-Directus.png)
...
![Interface utilisateur du CMS headless Cockpit](./Interface-du-CMS-headless-Cockpit.png)
