...
title: "UAV Ground Control Station web app with NodeJS Serialport"
subtitle: "Node.js Serialport, MAVLink, websockets, Angular.js, CSS3 animations."
date: "2013-05-29"
...
cover: "./Nodejs_websockets__angular_mavlink_ground-control-station.png"
---

[Nodejs_websockets__angular_mavlink_ground-control-station](./Nodejs_websockets__angular_mavlink_ground-control-station-495x400.jpg)
...
[radio-telemetry-kit-433mhz](./radio-telemetry-kit-433mhz.jpg)
...
The flight informations can then be displayed and updated in real time on the web interface thanks to [Angular.js](https://angularjs.org/) two way data-binding which automatically update the view when new data are available.
