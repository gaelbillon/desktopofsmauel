...
posttype: "work"
draft: false
path: "/uav-ground-control-station-web-app-with-node-serialport"
title: "UAV Ground Control Station web app with Node Serialport"
subtitle: "This application is a GCS short for Ground Cotrol Station."
date: "2013-05-29"
category: "Mobile applications"
tags: 
  - "English"
  - "Mobile applications"
intro: "A Ground Control Station for drones using Node.js Serialport module and MAVLink protocol. Made with HTML5, CSS3, Angular.js, Node.js & websockets."
color: "#125E8A"
url: "https://github.com/gaelbillon/Nodejs-Websockets-GCS"
cover: "./Nodejs_websockets__angular_mavlink_ground-control-station.jpg"
---

[![Nodejs_websockets__angular_mavlink_ground-control-station](./2013-05-29---uav-ground-control-station-web-app-with-node-serialport/Nodejs_websockets__angular_mavlink_ground-control-station-495x400.jpg)](/posts/wp-content/uploads/2013/05/Nodejs_websockets__angular_mavlink_ground-control-station.jpg)
...
[![radio-telemetry-kit-433mhz](./2013-05-29---uav-ground-control-station-web-app-with-node-serialport/radio-telemetry-kit-433mhz.jpg)](http://store.3drobotics.com/products/3dr-radio-telemetry-kit-433-mhz)
Flight informations are read from the serial port with the Node.js module named [Node Serialport](https://www.npmjs.com/package/serialport) . The Serialport module read data from a 433 MHz telemetry module as the one shown above.
...
[Check out the project on GitHub](https://github.com/gaelbillon/Nodejs-Websockets-GCS)
