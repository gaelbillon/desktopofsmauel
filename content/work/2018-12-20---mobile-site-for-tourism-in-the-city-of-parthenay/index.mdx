...
![google maps logo](./2018-12-20---856/maps.jpg)All the venues are also accessible from a Google map, there again we retrieve from the cache when possible, the map readjusts its limits each time we add new POIs.  

![facebook logo](./2018-12-20---856/facebook_logo_detail.jpg)The facebook API is integrated into the application and allows you to bring a social side to the application by sharing a place, a news or an event.  

![jquery logo](./2018-12-20---856/jquery-logo.jpg)Some tools have saved us valuable time, such as jQueryMobile, which facilitates the creation of a mobile interface oriented "Single Page Application".

![handlebars logo](./2018-12-20---856/handlebars_logo-1.jpg)Handlebars.js, a template engine that automatically builds the HTML of each page according to the JSON you send it.  

![require.js logo](./2018-12-20---856/require.jpg)Require.js allows you to no longer worry about script chargging management.  

![coffeescript logo](./2018-12-20---856/coffeescript_logo-553d0e0b9fc0a816ef444280eeabc84d.jpg)CoffeScript to reduce the code and make it more elegant.  

![bash terminal logo](./2018-12-20---856/bash.png)A shell script compiles the LESS files, gathers and minimizes the scripts, checks the syntax, then compresses them into gzip, copies the files to the server, etc. This allows the application to be compiled in production mode with a simple command.  
